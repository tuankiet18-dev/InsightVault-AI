    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-0">
      ...
      <div className="relative bg-surface-0 rounded-2xl shadow-xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        <header className="px-6 py-4 border-b border-border flex items-center justify-between">
          <h2 className="text-lg font-bold text-surface-900">Create Workspace</h2>
          <button 
            type="button"
            onClick={resetAndClose}
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="space-y-4">
            <div>
              <label htmlFor="ws-name" className="block text-sm font-medium text-surface-900 mb-1.5">
            ...
            <div>
              <label htmlFor="ws-desc" className="block text-sm font-medium text-surface-900 mb-1.5">
