...
namespace InsightVault.API.Data.Migrations
{
    ...
    [Migration("20260529023822_SoftDeleteAwareUniqueIndexes")]
            ...
            modelBuilder.Entity("InsightVault.API.Domain.Entities.ChatSession", b =>
                {
                    ...
                    b.Property<Guid?>("ScopeWorkspaceId")
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ScopeDocumentId")
                        .HasDatabaseName("ix_chat_sessions_scope_document_id");

                    b.HasIndex("ScopeFolderId")
                        .HasDatabaseName("ix_chat_sessions_scope_folder_id");

                    b.HasIndex("ScopeWorkspaceId")
                        .HasDatabaseName("ix_chat_sessions_scope_workspace_id");

                    b.HasIndex("WorkspaceId")
                        .HasDatabaseName("ix_chat_sessions_workspace_id");

                    b.HasIndex("ScopeType", "ScopeWorkspaceId", "ScopeFolderId", "ScopeDocumentId")
                        .HasDatabaseName("ix_chat_sessions_scope_type_scope_workspace_id_scope_folder_id");
            ...
            modelBuilder.Entity("InsightVault.API.Domain.Entities.ChatSession", b =>
                {
                    ...
                    b.HasOne("InsightVault.API.Domain.Entities.Document", "ScopeDocument")
                        .WithMany("ChatSessions")
                        .HasForeignKey("ScopeDocumentId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_chat_sessions_documents_scope_document_id");

                    b.HasOne("InsightVault.API.Domain.Entities.Folder", "ScopeFolder")
                        .WithMany("ChatSessions")
                        .HasForeignKey("ScopeFolderId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_chat_sessions_folders_scope_folder_id");

                    b.HasOne("InsightVault.API.Domain.Entities.Workspace", "ScopeWorkspace")
                        .WithMany()
                        .HasForeignKey("ScopeWorkspaceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("fk_chat_sessions_workspaces_scope_workspace_id");
                    ...
                    b.Navigation("ScopeDocument");

                    b.Navigation("ScopeFolder");

                    b.Navigation("ScopeWorkspace");
